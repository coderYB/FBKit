...
@interface FBAddressTableViewCell : FBBaseTableViewCell
...
@end
@implementation FBAddressTableViewCell
...
@end
@interface FBAddressViewController ()

@property (nonatomic ,strong) FBAddressBridge *bridge;

@property (nonatomic ,strong) UIButton *completeItem;

@property (nonatomic ,copy ) FBAddressBlock addressBlock;
@end
...
+ (instancetype)createAddressWithBlock:(FBAddressBlock) addressBlock {
    ...
    return [[FBAddressViewController alloc] initWithBlock:addressBlock];
}
- (instancetype)initWithBlock:(FBAddressBlock) addressBlock {
...
- (void)configOwnSubViews {
    ...
    [self.tableView registerClass:[FBAddressTableViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)configTableViewCell:(id)data forIndexPath:(NSIndexPath *)ip {
    ...
    FBAddressTableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"cell"];
    
    if (!cell) {
        
        cell = [[FBAddressTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
